...
//        assertTrue(imageDao.getImgById(user.getProfileImage()).isPresent());
//        assertNull(imageDao.getImgById(user.getProfileImage()).get().getImage());
...
//        assertEquals(new Long(15), user.get().getProfileImage());
