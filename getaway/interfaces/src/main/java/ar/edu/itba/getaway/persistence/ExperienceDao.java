...
public interface ExperienceDao {
    ...
    //Filters
    //TODO: Pasar order como String y concatenar a la query
    List<ExperienceModel> listByFilterWithCity(long categoryId, Double max, long cityId, long score, int page, int page_size);

    List<ExperienceModel> listByFilterWithCityAsc(long categoryId, Double max, long cityId, long score, String order, int page, int page_size);

    List<ExperienceModel> listByFilterWithCityDesc(long categoryId, Double max, long cityId, long score, String order, int page, int page_size);

    List<ExperienceModel> listByFilter(long categoryId, Double max, long score, int page, int page_size);

    List<ExperienceModel> listByFilterAsc(long categoryId, Double max, long score, String order, int page, int page_size);

    List<ExperienceModel> listByFilterDesc(long categoryId, Double max, long score, String order, int page, int page_size);
