...
//    ExperienceModel getMaxPriceByCategoryAndName(CategoryModel category, String name);
    ...
    List<ExperienceModel> listExperiencesSearchByUser(String name, UserModel user, OrderByModel order, int page, int pageSize);

    long getCountExperiencesByUser(String name, UserModel user);

    List<ExperienceModel> listExperiencesFavsByUser(UserModel user, OrderByModel order, int page, int pageSize);
    ...
    List<ExperienceModel> getRecommendedByReviewsCity(UserModel user, int maxResults, List<Long> alreadyAdded);

    List<ExperienceModel> getRecommendedByReviewsProvider(UserModel user, int maxResults, List<Long> alreadyAdded);

    List<ExperienceModel> getRecommendedByReviewsCategory(UserModel user, int maxResults, List<Long> alreadyAdded);
}
