                ...
                <c:otherwise>
                    <div class="dropdown">
                        <button class="btn button-primary dropdown-toggle d-flex align-items-center" type="button"
                            ...
                            <img src="<c:url value="/resources/images/ic_user_white.svg"/>" alt="Icono usuario"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="left: -50px;">
                            ...
                            <c:if test="${loggedUser.hasRole('PROVIDER')}">
                                <a class="dropdown-item" href="<c:url value="/user/experiences"/>">
                                    <img src="<c:url value="/resources/images/ic_experiences.svg"/>"
    ...
    <div class="container-types container-fluid pb-2 p-0 d-flex justify-content-center m-0">
        <a href="<c:url value="/experiences/Aventura"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Aventura.svg"/>" alt="Logo aventura"/>
        ...
        <a href="<c:url value="/experiences/Gastronomia"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Gastronomia.svg"/>" alt="Logo aventura"/>
        ...
        <a href="<c:url value="/experiences/Hoteleria"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Hoteleria.svg"/>" alt="Logo aventura"/>
        ...
        <a href="<c:url value="/experiences/Relax"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Relax.svg"/>" alt="Logo aventura"/>
        ...
        <a href="<c:url value="/experiences/Vida_nocturna"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Vida_nocturna.svg"/>" alt="Logo aventura"/>
        ...
        <a href="<c:url value="/experiences/Historico"/>">
            <button type="button"
                ...
                <img src="<c:url value="/resources/images/Historico.svg"/>" alt="Logo aventura"/>
