                                    ...
                                    <c:forEach begin="${index}" step="1"
                                        ...
                                        <jsp:include page="/WEB-INF/components/card_experience.jsp">
                                            <jsp:param name="hasImage"
                                                       value="${categoryList.get(experience).hasImage}"/>
                                            <jsp:param name="categoryName"
                                                       value="${categoryList.get(experience).categoryName}"/>
                                            <jsp:param name="id" value="${categoryList.get(experience).experienceId}"/>
                                            <jsp:param name="name"
                                                       value="${categoryList.get(experience).experienceName}"/>
                                            ...
                                            <jsp:param name="avgReviews"
                                                       value="${avgReviews[categoryIndex.index][myIndex.index]}"/>
                                            <jsp:param name="reviewCount"
                                                       value="${listReviewsCount[categoryIndex.index][myIndex.index]}"/>
