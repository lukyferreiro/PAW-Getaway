                ...
                <div class="col-12">
                    <div class="container-lg">
                        <div class="row">
                            ...
                            <form:form modelAttribute="editProfileForm" action="${postPath}" id="editProfileForm"
                                ...
                                <div class="form-group my-2"> <!--Nombre-->
                                    ...
                                    <form:label path="name" class="form-label d-flex justify-content-between">
                                        ...
                                        <div class="align-self-center">
                                            <h6 class="max-input-text"><spring:message code="editProfile.maxInput"
                                                                                       arguments="50"/></h6>
                                        </div>
                                    </form:label>
                                ...
                                <div class="form-group my-2"> <!--Imagenes-->
                                    ...
                                    <form:input path="profileImg" type="file" class="form-control"
                                                cssErrorClass="form-control is-invalid"/>
                                ...
                                <div class="p-0 mt-3 mb-0 d-flex justify-content-around">
                                    ...
                                    <button type="submit" class="btn btn-submit-form px-3 py-2"
                                            id="editProfileFormButton" form="editProfileForm">
