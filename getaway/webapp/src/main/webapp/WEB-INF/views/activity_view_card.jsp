    ...
    <div class="card activity-view">
        ...
        <div class="card-img-overlay buttons save">
            <button type="button" class="btn btn-circle btn-xl ">
                <img src="<e:url value = "/resources/images/ic_bookmark_white.svg" />"  alt="Guardar"/>
            </button>
        </div>
        <div class="card-body">
            <h2 class="card-title">Experience Name</h2>
            <p>experience.address</p>
            <p>experience.ranking <img src="<e:url value = "/resources/images/ic_star.svg" />"  alt="Icono estrella"></p>
        </div>
    </div>
</body>
</html>
