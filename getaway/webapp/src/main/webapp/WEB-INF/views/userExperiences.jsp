            ...
            <c:otherwise>
                ...
                <div class="d-flex justify-content-center align-content-center">
                    ...
                    <div class="d-flex justify-content-center align-content-center"
                        ...
                        <form:form modelAttribute="searchFormPrivate" action="${searchPrivateGetPath}"
                                   id="searchExperiencePrivateForm" method="get"
                                   acceptCharset="UTF-8" cssClass="my-auto">
                            <form:input path="userQuery" type="text" class="form-control"
                            ...
                            <table class="table table-bordered table-hover table-fit">
                                ...
                                <c:forEach var="experience" items="${experienceList}" varStatus="myIndex">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="container-fluid d-flex p-2 mb-1 align-items-end">
                                                <h4 class="container-fluid p-0">
                                                    <spring:message
                                                            code="experienceForm.${experience.category.categoryName}"/>
                                                </h4>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="container-fluid d-flex p-2 mb-1 align-items-end">
                                                <h5 class="mb-1">
                                                    <spring:message code="experience.reviews"
                                                                    arguments="${experience.reviewCount}"/>
                                                </h5>
                                            ...
                                            <div class="container-fluid d-flex p-2 mb-1 align-items-end">
                                                <h5 class="mb-1">
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <spring:message code="experience.price.value"
                                                                            arguments="${experience.price}"/>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </h5>
                                            </div>
                                        ...
                                        <td>
                                            <div class="btn-group w-auto container-fluid p-2 d-flex align-items-end"
                                                 role="group">
                                                <c:choose>
                                          ...
                                          <c:param name="experience" value="${experience.experienceId}"/>
                                                            ...
                                                            <button type="button" class="btn btn-observable"
                                                                    style="font-size: x-large" id="setFalse">
                                                                <i class="bi bi-eye"></i>
                                                            </button>
                                                        </a>
                                                    </c:when>
                                          ...
                                          <c:param name="experience" value="${experience.experienceId}"/>
                                                            ...
                                                            <button type="button" class="btn btn-observable"
                                                                    style="font-size: x-large" id="setTrue">
