    ...
    <div class="d-flex flex-column justify-content-center mx-5 my-2 p-0">
        ...
        <form:form modelAttribute="experienceForm" action="${postPath}" id="createExperienceForm" method="post"
            ...
            <div class="container-inputs">
                <div class="p-0 m-0 d-flex">
                    <div class="col m-2"> <!--Nombre de la experiencia-->
                        <form:label path="experienceName" class="form-label d-flex justify-content-between">
                            ...
                            <div class="align-self-center">
                                <h6 class="max-input-text"><spring:message code="experienceForm.maxInput"
                                                                           arguments="50"/></h6>
                            </div>
                        </form:label>
                        <form:input maxlength="50" path="experienceName" type="text" class="form-control"
                    ...
                    <div class="col m-2"> <!--Categoria-->
                        ...
                        <form:select path="experienceCategory" class="form-select"
                                     cssErrorClass="form-control is-invalid">
                    ...
                    <div class="col m-2"> <!--Precio-->
                        ...
                        <form:input path="experiencePrice" type="text" class="form-control"
                                    id="experienceFormPriceInput"
                ...
                <div class="p-0 m-2 d-flex flex-column"> <!--Descripcion-->
                    ...
                    <form:textarea maxlength="500" path="experienceInfo" class="form-control"
                                   cssErrorClass="form-control is-invalid" rows="4" cssStyle="max-height: 300px;"/>
                ...
                <div class="p-0 m-0 d-flex">
                    ...
                    <div class="col m-2"> <!--Url-->
                        ...
                        <form:input maxlength="500" path="experienceUrl" id="experienceFormUrlInput" type="text"
                                    cssErrorClass="form-control is-invalid" class="form-control"
                ...
                <div class="p-0 m-0 d-flex">
                    <div class="col m-2"> <!--Pais-->
                        ...
                        <form:select path="experienceCountry" id="experienceFormCountryInput" class="form-select"
                                     cssErrorClass="form-control is-invalid">
                    ...
                    <div class="col m-2"> <!--Direccion-->
                        ...
                        <form:input maxlength="100" path="experienceAddress" type="text" class="form-control"
                                    cssErrorClass="form-control is-invalid"/>
                ...
                <div class="p-0 m-2 d-flex flex-column"> <!--Imagenes-->
                    ...
                    <form:input path="experienceImg" type="file" class="form-control"
                                cssErrorClass="form-control is-invalid"/>
            ...
            <div class="p-0 mt-3 mb-0 d-flex justify-content-around">
                ...
                <button type="submit" class="btn btn-submit-form px-3 py-2" id="createExperienceFormButton"
