...
<div class="container-main">
    ...
    <div class="container-fluid p-0 mt-3 d-flex">
        <div class="container-filters container-fluid px-2 py-0 mx-2 my-0 d-flex flex-column justify-content-start align-items-center border-end">
            ...
            <form:form modelAttribute="filterForm" action="${getPath}" cssClass="filter-form" id="submitForm"
                       method="get" acceptCharset="UTF-8">
                <div>
                ...
                <div class="container-slider-price">
                    <form:label path="maxPrice" class="form-label"><spring:message
                            code="filters.price.title"/></form:label>
                ...
                <div>
                    ...
                    <form:input value="${score}" path="score" type="hidden" class="form-control"
            ...
            <a href="<c:url value = "/experiences/${categoryName}">
                ...
                <button class="btn btn-clean-filter px-3 py-2 my-2" type="button" id="cleanFilterFormButton"
                        form="submitForm">
