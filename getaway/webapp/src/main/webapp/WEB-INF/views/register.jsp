...
<head>
    ...
    <link href="<c:url value = "/resources/css/loginRegister.css"/>" rel="stylesheet" type="text/css"/>
</head>
                ...
                <div class="col-12">
                    <div class="container-lg">
                        <div class="row">
                            ...
                            <form:form modelAttribute="registerForm" action="${postPath}" id="registerForm"
                                ...
                                <div class="form-group"> <!--Email-->
                                    ...
                                    <form:label path="email" class="form-label d-flex justify-content-between">
                                        ...
                                        <div class="align-self-center">
                                            <h6 class="max-input-text"><spring:message code="register.maxInput"
                                                                                       arguments="255"/></h6>
                                        </div>
                                    </form:label>
                                    <form:input maxlength="255" type="text" path="email" id="email"
                                ...
                                <div class="form-group"> <!--Nombre-->
                                    ...
                                    <form:input maxlength="50" type="text" path="name" id="name"
                                                cssErrorClass="form-control is-invalid"
                                ...
                                <div class="form-group"> <!--Apellido-->
                                    ...
                                    <form:input maxlength="50" type="text" path="surname"
                                                cssErrorClass="form-control is-invalid" id="surname"
                                ...
                                <div class="form-group"> <!--Contraseña-->
                                    ...
                                    <div class="input-group d-flex justify-content-start align-items-center">
                                        <spring:message code="registerForm.password.placeholder"
                                ...
                                <div class="col-12 px-0 d-flex align-items-center justify-content-center">
                                    <button type="button" id="registerFormButton" form="registerForm"
                                            class="w-100 btn-create-account my-2 ">
