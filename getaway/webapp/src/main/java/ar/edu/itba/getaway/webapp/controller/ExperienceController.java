...
public class ExperienceController {
    ...
    @RequestMapping(value = "/experiences/{categoryName:[A-Za-z]+}", method = {RequestMethod.GET})
    ...
    @RequestMapping("/experiences/{categoryName:[A-Za-z]+}/{experienceId:[0-9]+}")
...
//        experienceAvgReview.ifPresent(aLong -> mav.addObject("reviewAvg", aLong));
    ...
    @RequestMapping(value = "/experiences/{categoryName:[A-Za-z]+}", method = {RequestMethod.POST})
