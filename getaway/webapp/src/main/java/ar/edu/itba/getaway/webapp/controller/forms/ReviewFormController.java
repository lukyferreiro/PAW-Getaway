...
public class ReviewFormController {
    ...
    @RequestMapping(value = "/experiences/{categoryName:[A-Za-z]+}/{experienceId:[0-9]+}/create_review", method = {RequestMethod.GET})
    ...
    @RequestMapping(value = "/experiences/{categoryName:[A-Za-z]+}/{experienceId:[0-9]+}/create_review", method = {RequestMethod.POST})
