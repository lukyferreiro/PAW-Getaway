...
public class AuthFilter extends OncePerRequestFilter {
    ...
    private static final RequestMatcher LOGIN_ENDPOINT_MATCHER = new OrRequestMatcher(new AntPathRequestMatcher("/auth/login"), new AntPathRequestMatcher("/auth/login/"));
    private static final RequestMatcher REFRESH_ENDPOINT_MATCHER = new OrRequestMatcher(new AntPathRequestMatcher("/auth/refreshToken"), new AntPathRequestMatcher("/auth/refreshToken/"));
    private static final RequestMatcher AUTH_NAMESPACE_MATCHER = new AntPathRequestMatcher("/auth/**");
    private static final RequestMatcher AUTH_ENDPOINTS_MATCHER = new OrRequestMatcher(REFRESH_ENDPOINT_MATCHER, LOGIN_ENDPOINT_MATCHER);
...
//        addSessionRefreshTokenHeader(response, user);
    ...
    private void addAuthorizationHeader(final HttpServletResponse response, final UserModel user) {
